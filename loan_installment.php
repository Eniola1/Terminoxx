                                           ...
                                           <?php foreach($installment as $value): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center">
                                                    <a role="button" title="Edit" class="btn btn-sm btn-info waves-effect waves-light installment" data-id="<?php echo $value->id ?>"><i class="fa fa-pencil-square-o"></i></a>
                                                    <a role="button" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
