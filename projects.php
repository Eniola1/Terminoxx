            ...
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <?php } else { ?>
                        <a role="button" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" id="addNewApplication" class="btn btn-info text-white"><i class="fa fa-plus"></i> Add Project </a>
                        <a role="button" href="<?= base_url(); ?>Projects/All_Tasks" class="btn btn-primary text-white"><i class="fa fa-bars"></i>  Task List</a>
                        <a role="button" href="<?= base_url(); ?>Projects/Field_visit" class="btn btn-primary text-white"><i class="fa fa-bars"></i>  Field Visit List</a>
                        <?php } ?>
                    </div>
                </div>
                <div class="row">
                                        ...
                                        <tbody>
                                           <?php foreach($projects as $value): ?>
                                            <tr>
                                                ...
                                                <td><?=ucwords($value->pro_status) ?></td>
                                                <td><?= date('jS \of F Y',strtotime($value->pro_start_date)); ?></td>
                                                <td><?= date('jS \of F Y',strtotime($value->pro_end_date)) ?></td>
                                                <td class="jsgrid-align-center ">
                                                    <a href="view?P=<?= base64_encode($value->id); ?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>
                                                    <?php if($this->session->userdata('user_type')=='ADMIN'){ ?>
                                                    <a onclick="deleteRecord(<?=$value->id?>,'projects/pDelet')" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash text-white"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="protitle" class="form-control" id="recipient-name1" minlength="3" maxlength="250" placeholder="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="details" id="message-text1" minlength="4" maxlength="1300" rows="8" placeholder=""> </textarea>
                                    </div>
                                    <div class="form-group">
