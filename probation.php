                                ...
                                <tbody>
                                    ...
                                    <tr style="vertical-align:top">
                                        ...
                                        <td>
                                            ...
                                            <a title="Delete" class="btn btn-sm btn-danger waves-effect waves-light text-white" onclick="deleteRecord(<?=$value->id?>, 'probation/deleteProbation')"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
