...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/account1/main.css">
...
<div class="page-wrapper" style="background-color:white">
    ...
    <div class="row m-b-10" style="background:white; padding: 10px 15px;"> 
            <div class="col-12">
                <a class="btn btn-primary text-white "><i class="fa fa-bars"></i> ACCOUNT 1 </a>
    ...
    <script src="<?php echo base_url(); ?>assets/js/account1/tree.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/account1/main.js"></script>
