...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/hr/main.css">
...
<div class="page-wrapper" style="background-color:white">
    ...
    <div class="row m-b-10" style="background:white; padding: 10px 15px;"> 
            <div class="col-12">
                <a class="btn btn-primary text-white "><i class="fa fa-bars"></i> HUMAN RESOURCES </a>
    ...
    <div class="container-fluid" style="display:flex; justify-content:center; background-color:white">
            ...
            <div id="control_panel">
                ...
                <div style="position: absolute;top: -180px;width: 100vw;height: 1px;background: lightgray;"></div>
                <div style="position: absolute; top: -150px; border-left: 4px solid #1E007F;  padding: 10px 15px; display: flex; flex-direction: column; justify-content: center;background: #fff; width: 250px; min-height: 80px; font-family: Source Sans Pro">
                    <div id="name" style=" 
    ...
    <script src="<?php echo base_url(); ?>assets/js/hr/tree.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/hr/main.js"></script>
