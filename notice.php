    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row m-b-10"> 
                <div class="col-12">
                    <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#announcementModal" data-whatever="@getbootstrap" class="text-white "><i class="" aria-hidden="true"></i> Add Announcement </a></button>
                </div>
            </div> 
            <div class="row">
                <div class="col-12">
                    <div class="card card-outline-info" style="box-shadow: none!important">
                        ...
                        <div class="card-body" style="background:#EDECEC">
                            <div class="mailbox-read-info row">
                                <div class="col-md-12 notice-box">
                                    ...
                                    <span style="color:#B22222; float:right;position:relative; bottom: 30px; cursor: pointer" class="iconify" data-icon="eva:close-fill" onclick="deleteRecord(<?=$value->id?>, `notice/deleteNotice`)" ></span>
