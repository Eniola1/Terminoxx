                                   ...
                                   <div class="row">
                                       <div class="col-md-4">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <center class="m-t-30"> 
                                                    <h2 class="m-t-10"><?=$details->pro_name; ?></h2>
                                                </center>
                                            </div>
                                            <div>
                                                <hr> 
                                            ...
                                            <div class="card-body"> <small class="text-muted">Start Date </small>
                                                <h6><?=date('jS \of F Y',strtotime($details->pro_start_date))  ?></h6> <small class="text-muted p-t-30 db">End date</small>
                                                <h6><?=date('jS \of F Y',strtotime($details->pro_end_date))  ?></h6> <small class="text-muted p-t-30 db">Status</small>
                                                <h6><?=ucwords($details->pro_status); ?></h6>
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="protitle" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?= $details->pro_name; ?>" class="form-control" id="recipient-name1" minlength="8" maxlength="250" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Project Start Date</label>
                                                <input type="text" name="startdate" value="<?= $details->pro_start_date; ?>" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control mydatepicker" id="recipient-name1" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Project End Date</label>
                                                <input type="text" name="enddate" value="<?= $details->pro_end_date; ?>" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control mydatepicker" id="recipient-name1" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="message-text" class="control-label">Project Summery</label>
                                                <textarea class="form-control" value="<?= $details->pro_summary; ?>" name="summery" rows="6" id="message-text1" minlength="5" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> maxlength="512" ><?= $details->pro_summary; ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="message-text" class="control-label">Details</label>
                                                <textarea class="form-control" rows="10" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> name="details" value="<?= $details->pro_description; ?>" id="message-text1" minlength="10" maxlength="1300"><?= $details->pro_description; ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="prostatus" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> required>
                                                    <option value="<?= $details->pro_status; ?>"><?= $details->pro_status; ?></option>
                                    ...
                                    <div class="modal-footer">
                                       <input type="hidden" name="proid" value="<?= $details->id; ?>">
                            ...
                            <tbody>
                               <?php foreach($tasklist as $value): ?>
                                <tr>
                                    ...
                                    <img src="<?= base_url(); ?>assets/images/users/<?= $value1->em_image ?>" height="40px" width="40px" style="border-radius:50px" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?= $value1->user_type; ?>">
                            ...
                            <tbody>
                               <?php foreach($tasklist as $value): ?>
                                <tr>
                                    ...
                                    <img src="<?= base_url(); ?>assets/images/users/<?= $value1->em_image ?>" height="40px" width="40px" style="border-radius:50px" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?= $value1->user_type; ?>">
                                    <?php } else { ?>
                                    <img src="<?= base_url(); ?>assets/images/users/user.png ?>" height="40px" width="40px" style="border-radius:50px" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?= $value1->user_type; ?>">
                                    <?php } ?>
                                    ...
                                    <td class="jsgrid-align-center ">
                                        <a href="#" title="Edit" class="btn btn-sm btn-info waves-effect waves-light taskmodal" data-id="<?= $value->id ?>"><i class="fa fa-pencil-square-o"></i></a>
                                        <a onclick="alert('Are you sure want to delet this Value?')" href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light TasksDelet" data-id="<?= $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                    <?php } ?>
                                </tr>
                                <?php endforeach; ?>
                            ...
                            <tbody>
                               <?php foreach($files as $value): ?>
                                <tr>
                                    ...
                                    <td>
                                    <a href="<?= base_url(); ?>assets/images/projects/<?= $value->file_url ?>" title="" data-toggle="app-modal" data-sidebar="1" data-url="<?= base_url(); ?>assets/images/projects/<?= $value->file_url ?>"><?= $value->file_url ?></a>
                                    </td>
                                    <td><img src="<?= base_url(); ?>assets/images/users/<?= $value->em_image ?>" height="40px" width="40px" style="border-radius:50px" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?= $value->first_name; ?>">
                                    </td>
                                    
                                    <td class="jsgrid-align-center ">
                                       <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                                        <a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light filedelet" data-id="<?= $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                               <?php foreach($notes as $value): ?>
                                <tr>
                                    <td><?= $value->details?></td>
                                    <td><img src="<?= base_url(); ?>assets/images/users/<?= $value->em_image ?>" height="40px" width="40px" style="border-radius:50px" alt=""></td>
                                    <td class="jsgrid-align-center ">
                                        <a href="#" title="Edit" class="btn btn-sm btn-info waves-effect waves-light notes" data-id="<?= $value->id ?>"><i class="fa fa-pencil-square-o"></i></a>
                                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                                        <a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light notesdelet" data-id="<?= $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            ...
                            <tbody>
                               <?php foreach($expenses as $value): ?>
                                <tr>
                                    ...
                                    <td><img src="<?= base_url(); ?>assets/images/users/<?= $value->em_image ?>" height="40px" width="40px" style="border-radius:50px" title="<?= $value->first_name.' '.$value->last_name ?>" alt=""></td>
                                    <td><?= $value->date ?></td>
                                    <td><?= $value->amount ?></td>
                                    <td class="jsgrid-align-center ">
                                       <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                                        <a href="#" title="Edit" class="btn btn-sm btn-info waves-effect waves-light expenses" data-id="<?= $value->id ?>"><i class="fa fa-pencil-square-o"></i></a>
                                        <a href="#" onclick="confirm('are you sure want to delet this value')" title="Delete" class="btn btn-sm btn-info waves-effect waves-light exdelet" data-id="<?= $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
			                                ...
			                                <form class="row" action="Add_Expenses" method="post" enctype="multipart/form-data" id="expenseform">
                                                ...
                                                ?>                                                   
                                                    ...
                                                    <option value="<?= $value->em_id ?>"><?= $value->first_name.' '.$value->last_name; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
			                                    </div>
			                                    <div class="form-group col-md-6 m-t-5">
                            ...
                            <tbody>
                               <?php foreach($logisticlist as $value): ?>
                                <tr>
                                    ...
                                    <td><?= $value->end_date ?></td>
                                    <td class="jsgrid-align-center ">
                                        <a href="#" title="Edit" class="btn btn-sm btn-info waves-effect waves-light logisticeid" id="logisticeid" data-id="<?= $value->ass_id ?>"><i class="fa fa-pencil-square-o"></i></a>
                                        <!--<a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>-->
                                    </td>
                                </tr>
                                <?php endforeach; ?>
