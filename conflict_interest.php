                                ...
                                <tbody>
                                    ...
                                    <tr style="vertical-align:top">
                                        ...
                                        <td>
                                            ...
                                            <a role="button" data-toggle="modal" data-id="<?=$value->id?>" title="Delete" onclick="deleteRecord($(this).data('id'), `conflictOfinterest/deleteConflictOfinterest`)" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash text-white"></i></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
