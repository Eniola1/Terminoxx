            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <a href="<?=base_url(); ?>employee/disciplinary_report" class="btn btn-primary text-white"><i class="fa fa-bars"></i> Disciplinary Report</a>
                    </div>
                </div>         
                <div class="row">
                    <div class="col-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($value->close_action):?>
                                                        Closed
                                                    <?php else:?>
                                                        <?php $value->response == null ?  $status = 'No Response':  $status = 'Responded'; echo $status;?>
                                                    <?php endif;?>
                                                </td>
