         ...
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <a href="<?php echo base_url(); ?>employee/Add_employee" class="btn btn-info text-white"><i class="fa fa-plus"></i> Add Employee</a>
						<a  class="btn btn-info text-white" data-toggle="modal" data-target="#Bulkmodal"><i class="fa fa-plus"></i>  Add Bulk Employees</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                           ...
                                           <?php foreach($employee as $value): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    <a href="<?=base_url(); ?>employee/view?id=<?=$value->em_id?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>
