         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">   <?=($departmentName.' '.'Department') ?></h3>
                </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           <?php foreach($departmentDetails as $value): ?>
                                            <tr>
                                                <td title="<?=ucwords($value->first_name .' '.$value->last_name); ?>"><?= ucwords($value->first_name) .' '.ucwords($value->last_name); ?></td>
