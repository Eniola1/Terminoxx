...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"> </i> Peer Review</h3>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <form class="row" action="<?= base_url()?>appraisal/addPeerReview" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-3 m-t-10">
                                ...
                                <select name="em_id" class="form-control custom-select select2" required>
                            ...
                            <div class="form-group col-md-3 m-t-10">
                                ...
                                <input class="form-check-input" type="radio" value="Annual" id="annual" name="type_of_appraisal" checked>
                                <label class="form-check-label" for="annual" style="padding-top: 0">
                                    Annual
                                </label>
                                <input class="form-check-input" type="radio" value="Semi-Annual" id="semi" name="type_of_appraisal">
                                <label class="form-check-label" for="semi" style="padding-top: 0">
                                    Semi-Annual
                                </label>
                                <input class="form-check-input" type="radio" value="Probation" id="prob" name="type_of_appraisal">
                            ...
                            <div class="form-group col-md-3 m-t-10">
                                ...
                                <input type="date" id="" name="review_start" class="form-control" required/>
                            </div>
                            <div class="form-group col-md-3 m-t-10">
                                <label>Period Under Review (To) </label>
                                <input type="date" id="" name="review_end" class="form-control" required/>
                            </div>
                            ...
                            <div class="form-group col-md-4 m-t-10">
                                ...
                                <ul>
                                    ...
                                    <li>Work Must Seldom Be Checked By Others</li>
                            ...
                            <div class="form-group col-md-4 m-t-10">
                                ...
                                <ul>
                                    ...
                                    <li>Work Must Be Checked By Others</li>
